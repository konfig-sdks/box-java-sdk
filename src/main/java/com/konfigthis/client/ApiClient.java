...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.box.com/2.0";
    private String tokenUrl = "https://api.box.com/oauth2/token";
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        authentications.put("OAuth2Security", oauth);
        return oauth;
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.box.com/2.0)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g https://api.box.com/oauth2/token)
     * @return An instance of OkHttpClient
     */
