...
public class CollaborationItem {
  ...
  **/
  ...
  public CollaborationItem sequenceId(String sequenceId) {
  ...
  **/
  ...
  public CollaborationItem fileVersion(FileVersionMini fileVersion) {
  ...
  **/
  ...
  public CollaborationItem pathCollection(Object pathCollection) {
  ...
  **/
  ...
  public CollaborationItem createdBy(UserMini createdBy) {
  ...
  **/
  ...
  public CollaborationItem modifiedBy(UserMini modifiedBy) {
  ...
  **/
  ...
  public CollaborationItem ownedBy(UserMini ownedBy) {
  ...
  **/
  ...
  public CollaborationItem sharedLink(Object sharedLink) {
  ...
  **/
  ...
  public CollaborationItem parent(FolderMini parent) {
  ...
  **/
  ...
  public CollaborationItem itemCollection(Items itemCollection) {
  ...
  **/
   ...
   * @return the CollaborationItem instance itself
   */
  public CollaborationItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, collaborationItem.id) &&
        Objects.equals(this.etag, collaborationItem.etag) &&
        ...
        Objects.equals(this.additionalProperties, collaborationItem.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, etag, type, sequenceId, name, sha1, fileVersion, description, size, pathCollection, createdAt, modifiedAt, trashedAt, purgedAt, contentCreatedAt, contentModifiedAt, createdBy, modifiedBy, ownedBy, sharedLink, parent, itemStatus, folderUploadEmail, itemCollection, url, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CollaborationItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CollaborationItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CollaborationItem>() {
           ...
           public CollaborationItem read(JsonReader in) throws IOException {
             ...
             CollaborationItem instance = thisAdapter.fromJsonTree(jsonObj);
