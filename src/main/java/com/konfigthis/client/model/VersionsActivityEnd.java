...
public class VersionsActivityEnd {
 ...
 public enum TypeEnum {
  ...
  public VersionsActivityEnd() {
  }

  public VersionsActivityEnd createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public VersionsActivityEnd createdBy(FaFileVersionCreatedBy createdBy) {
  ...
  **/
  ...
  public VersionsActivityEnd id(String id) {
  ...
  **/
  ...
  public VersionsActivityEnd number(Integer number) {
  ...
  **/
  ...
  public VersionsActivityEnd restoredAt(OffsetDateTime restoredAt) {
  ...
  **/
  ...
  public VersionsActivityEnd restoredBy(FaFileVersionRestoredBy restoredBy) {
  ...
  **/
  ...
  public VersionsActivityEnd trashedAt(OffsetDateTime trashedAt) {
  ...
  **/
  ...
  public VersionsActivityEnd trashedBy(FaFileVersionTrashedBy trashedBy) {
  ...
  **/
  ...
  public VersionsActivityEnd type(TypeEnum type) {
  ...
  **/
   ...
   * @return the VersionsActivityEnd instance itself
   */
  public VersionsActivityEnd putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VersionsActivityEnd versionsActivityEnd = (VersionsActivityEnd) o;
    return Objects.equals(this.createdAt, versionsActivityEnd.createdAt) &&
        Objects.equals(this.createdBy, versionsActivityEnd.createdBy) &&
        Objects.equals(this.id, versionsActivityEnd.id) &&
        Objects.equals(this.number, versionsActivityEnd.number) &&
        Objects.equals(this.restoredAt, versionsActivityEnd.restoredAt) &&
        Objects.equals(this.restoredBy, versionsActivityEnd.restoredBy) &&
        Objects.equals(this.trashedAt, versionsActivityEnd.trashedAt) &&
        Objects.equals(this.trashedBy, versionsActivityEnd.trashedBy) &&
        Objects.equals(this.type, versionsActivityEnd.type)&&
        Objects.equals(this.additionalProperties, versionsActivityEnd.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VersionsActivityEnd {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VersionsActivityEnd
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VersionsActivityEnd.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VersionsActivityEnd is not found in the empty JSON string", VersionsActivityEnd.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VersionsActivityEnd.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VersionsActivityEnd.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VersionsActivityEnd' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VersionsActivityEnd> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VersionsActivityEnd.class));

       return (TypeAdapter<T>) new TypeAdapter<VersionsActivityEnd>() {
           @Override
           public void write(JsonWriter out, VersionsActivityEnd value) throws IOException {
           ...
           @Override
           public VersionsActivityEnd read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VersionsActivityEnd instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VersionsActivityEnd given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VersionsActivityEnd
  * @throws IOException if the JSON string is invalid with respect to VersionsActivityEnd
  */
  public static VersionsActivityEnd fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VersionsActivityEnd.class);
  }

 /**
  * Convert an instance of VersionsActivityEnd to an JSON string
  *
  * @return JSON string
  */
