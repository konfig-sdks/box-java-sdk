...
import com.konfigthis.client.model.ItemsAllOfOrder;
...
public class ItemsAllOf {
  ...
  private List<ItemsAllOfOrder> order = null;

  public ItemsAllOf() {
  }

  public ItemsAllOf totalCount(Long totalCount) {
  ...
  **/
  ...
  public ItemsAllOf limit(Long limit) {
  ...
  **/
  ...
  public ItemsAllOf offset(Long offset) {
  ...
  **/
  ...
  public ItemsAllOf order(List<ItemsAllOfOrder> order) {
  ...
  public ItemsAllOf addOrderItem(ItemsAllOfOrder orderItem) {
    if (this.order == null) {
  ...
  **/
  ...
  public List<ItemsAllOfOrder> getOrder() {
    return order;
  }


  public void setOrder(List<ItemsAllOfOrder> order) {
   ...
   * @return the ItemsAllOf instance itself
   */
  public ItemsAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ItemsAllOf itemsAllOf = (ItemsAllOf) o;
    return Objects.equals(this.totalCount, itemsAllOf.totalCount) &&
        Objects.equals(this.limit, itemsAllOf.limit) &&
        Objects.equals(this.offset, itemsAllOf.offset) &&
        Objects.equals(this.order, itemsAllOf.order)&&
        Objects.equals(this.additionalProperties, itemsAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ItemsAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ItemsAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemsAllOf is not found in the empty JSON string", ItemsAllOf.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("order") != null && !jsonObj.get("order").isJsonNull()) {
        ...
        if (jsonArrayorder != null) {
          ...
          for (int i = 0; i < jsonArrayorder.size(); i++) {
            ItemsAllOfOrder.validateJsonObject(jsonArrayorder.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemsAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemsAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemsAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemsAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemsAllOf>() {
           @Override
           public void write(JsonWriter out, ItemsAllOf value) throws IOException {
           ...
           @Override
           public ItemsAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ItemsAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ItemsAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ItemsAllOf
  * @throws IOException if the JSON string is invalid with respect to ItemsAllOf
  */
  public static ItemsAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemsAllOf.class);
  }

 /**
  * Convert an instance of ItemsAllOf to an JSON string
  *
  * @return JSON string
  */
