...
import com.konfigthis.client.model.SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions;
...
public class SharedLinksWebLinksUpdateSharedLinkRequestSharedLink {
  /**
 ...
 public enum AccessEnum {
  ...
  private SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions permissions;

  public SharedLinksWebLinksUpdateSharedLinkRequestSharedLink() {
  }

  public SharedLinksWebLinksUpdateSharedLinkRequestSharedLink access(AccessEnum access) {
  ...
  **/
  ...
  public SharedLinksWebLinksUpdateSharedLinkRequestSharedLink password(String password) {
  ...
  **/
  ...
  public SharedLinksWebLinksUpdateSharedLinkRequestSharedLink vanityName(String vanityName) {
  ...
  **/
  ...
  public SharedLinksWebLinksUpdateSharedLinkRequestSharedLink unsharedAt(OffsetDateTime unsharedAt) {
  ...
  **/
  ...
  public SharedLinksWebLinksUpdateSharedLinkRequestSharedLink permissions(SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions permissions) {
  ...
  **/
  ...
  public SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions getPermissions() {
    return permissions;
  }


  public void setPermissions(SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions permissions) {
   ...
   * @return the SharedLinksWebLinksUpdateSharedLinkRequestSharedLink instance itself
   */
  public SharedLinksWebLinksUpdateSharedLinkRequestSharedLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SharedLinksWebLinksUpdateSharedLinkRequestSharedLink sharedLinksWebLinksUpdateSharedLinkRequestSharedLink = (SharedLinksWebLinksUpdateSharedLinkRequestSharedLink) o;
    return Objects.equals(this.access, sharedLinksWebLinksUpdateSharedLinkRequestSharedLink.access) &&
        Objects.equals(this.password, sharedLinksWebLinksUpdateSharedLinkRequestSharedLink.password) &&
        Objects.equals(this.vanityName, sharedLinksWebLinksUpdateSharedLinkRequestSharedLink.vanityName) &&
        Objects.equals(this.unsharedAt, sharedLinksWebLinksUpdateSharedLinkRequestSharedLink.unsharedAt) &&
        Objects.equals(this.permissions, sharedLinksWebLinksUpdateSharedLinkRequestSharedLink.permissions)&&
        Objects.equals(this.additionalProperties, sharedLinksWebLinksUpdateSharedLinkRequestSharedLink.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SharedLinksWebLinksUpdateSharedLinkRequestSharedLink {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SharedLinksWebLinksUpdateSharedLinkRequestSharedLink
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SharedLinksWebLinksUpdateSharedLinkRequestSharedLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SharedLinksWebLinksUpdateSharedLinkRequestSharedLink is not found in the empty JSON string", SharedLinksWebLinksUpdateSharedLinkRequestSharedLink.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("permissions") != null && !jsonObj.get("permissions").isJsonNull()) {
        SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions.validateJsonObject(jsonObj.getAsJsonObject("permissions"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SharedLinksWebLinksUpdateSharedLinkRequestSharedLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SharedLinksWebLinksUpdateSharedLinkRequestSharedLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SharedLinksWebLinksUpdateSharedLinkRequestSharedLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SharedLinksWebLinksUpdateSharedLinkRequestSharedLink.class));

       return (TypeAdapter<T>) new TypeAdapter<SharedLinksWebLinksUpdateSharedLinkRequestSharedLink>() {
           @Override
           public void write(JsonWriter out, SharedLinksWebLinksUpdateSharedLinkRequestSharedLink value) throws IOException {
           ...
           @Override
           public SharedLinksWebLinksUpdateSharedLinkRequestSharedLink read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SharedLinksWebLinksUpdateSharedLinkRequestSharedLink instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SharedLinksWebLinksUpdateSharedLinkRequestSharedLink given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SharedLinksWebLinksUpdateSharedLinkRequestSharedLink
  * @throws IOException if the JSON string is invalid with respect to SharedLinksWebLinksUpdateSharedLinkRequestSharedLink
  */
  public static SharedLinksWebLinksUpdateSharedLinkRequestSharedLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SharedLinksWebLinksUpdateSharedLinkRequestSharedLink.class);
  }

 /**
  * Convert an instance of SharedLinksWebLinksUpdateSharedLinkRequestSharedLink to an JSON string
  *
  * @return JSON string
  */
