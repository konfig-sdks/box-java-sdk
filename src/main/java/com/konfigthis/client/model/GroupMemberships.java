 ...
 */
@ApiModel(description = "A list of group memberships.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class GroupMemberships {
  ...
  public GroupMemberships totalCount(Long totalCount) {
  ...
  **/
  ...
  public GroupMemberships limit(Long limit) {
  ...
  **/
  ...
  public GroupMemberships offset(Long offset) {
  ...
  **/
  ...
  public GroupMemberships order(List<GroupMembershipsAllOfOrder> order) {
  ...
  public GroupMemberships addOrderItem(GroupMembershipsAllOfOrder orderItem) {
    if (this.order == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of group memberships")
   ...
   * @return the GroupMemberships instance itself
   */
  public GroupMemberships putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalCount, groupMemberships.totalCount) &&
        Objects.equals(this.limit, groupMemberships.limit) &&
        Objects.equals(this.offset, groupMemberships.offset) &&
        Objects.equals(this.order, groupMemberships.order) &&
        Objects.equals(this.entries, groupMemberships.entries)&&
        Objects.equals(this.additionalProperties, groupMemberships.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroupMemberships
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroupMemberships.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupMemberships is not found in the empty JSON string", GroupMemberships.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("entries") != null && !jsonObj.get("entries").isJsonNull()) {
        ...
        if (jsonArrayentries != null) {
          ...
          for (int i = 0; i < jsonArrayentries.size(); i++) {
            GroupMembership.validateJsonObject(jsonArrayentries.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupMemberships.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupMemberships' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupMemberships> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupMemberships.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupMemberships>() {
           @Override
           public void write(JsonWriter out, GroupMemberships value) throws IOException {
           ...
           @Override
           public GroupMemberships read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroupMemberships instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroupMemberships given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroupMemberships
  * @throws IOException if the JSON string is invalid with respect to GroupMemberships
  */
  public static GroupMemberships fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupMemberships.class);
  }

 /**
  * Convert an instance of GroupMemberships to an JSON string
  *
  * @return JSON string
  */
