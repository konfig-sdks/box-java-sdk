...
public class FilesUpdateFileRequestSharedLink {
  /**
 ...
 public enum AccessEnum {
  ...
  public FilesUpdateFileRequestSharedLink() {
  }

  public FilesUpdateFileRequestSharedLink access(AccessEnum access) {
  ...
  **/
  ...
  public FilesUpdateFileRequestSharedLink password(String password) {
  ...
  **/
  ...
  public FilesUpdateFileRequestSharedLink vanityName(String vanityName) {
  ...
  **/
  ...
  public FilesUpdateFileRequestSharedLink unsharedAt(OffsetDateTime unsharedAt) {
  ...
  **/
  ...
  public FilesUpdateFileRequestSharedLink permissions(FilesUpdateFileRequestSharedLinkAllOfPermissions permissions) {
  ...
  **/
   ...
   * @return the FilesUpdateFileRequestSharedLink instance itself
   */
  public FilesUpdateFileRequestSharedLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FilesUpdateFileRequestSharedLink filesUpdateFileRequestSharedLink = (FilesUpdateFileRequestSharedLink) o;
    return Objects.equals(this.access, filesUpdateFileRequestSharedLink.access) &&
        Objects.equals(this.password, filesUpdateFileRequestSharedLink.password) &&
        Objects.equals(this.vanityName, filesUpdateFileRequestSharedLink.vanityName) &&
        Objects.equals(this.unsharedAt, filesUpdateFileRequestSharedLink.unsharedAt) &&
        Objects.equals(this.permissions, filesUpdateFileRequestSharedLink.permissions)&&
        Objects.equals(this.additionalProperties, filesUpdateFileRequestSharedLink.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FilesUpdateFileRequestSharedLink {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FilesUpdateFileRequestSharedLink
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FilesUpdateFileRequestSharedLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FilesUpdateFileRequestSharedLink is not found in the empty JSON string", FilesUpdateFileRequestSharedLink.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FilesUpdateFileRequestSharedLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FilesUpdateFileRequestSharedLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FilesUpdateFileRequestSharedLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FilesUpdateFileRequestSharedLink.class));

       return (TypeAdapter<T>) new TypeAdapter<FilesUpdateFileRequestSharedLink>() {
           @Override
           public void write(JsonWriter out, FilesUpdateFileRequestSharedLink value) throws IOException {
           ...
           @Override
           public FilesUpdateFileRequestSharedLink read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FilesUpdateFileRequestSharedLink instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FilesUpdateFileRequestSharedLink given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FilesUpdateFileRequestSharedLink
  * @throws IOException if the JSON string is invalid with respect to FilesUpdateFileRequestSharedLink
  */
  public static FilesUpdateFileRequestSharedLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FilesUpdateFileRequestSharedLink.class);
  }

 /**
  * Convert an instance of FilesUpdateFileRequestSharedLink to an JSON string
  *
  * @return JSON string
  */
