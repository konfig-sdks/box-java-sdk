 ...
 */
@ApiModel(description = "The representation of an upload session chunk.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UploadPart {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(partId, offset, size, sha1, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UploadPart
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UploadPart.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
