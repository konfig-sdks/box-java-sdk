...
import com.konfigthis.client.model.MetadataOptionWrite2;
...
public class MetadataFieldWrite {
 ...
 public enum TypeEnum {
  ...
  private List<MetadataOptionWrite2> options = null;

  public MetadataFieldWrite() {
  }
  ...
  **/
  ...
  public MetadataFieldWrite options(List<MetadataOptionWrite2> options) {
  ...
  public MetadataFieldWrite addOptionsItem(MetadataOptionWrite2 optionsItem) {
  ...
  **/
  ...
  public List<MetadataOptionWrite2> getOptions() {
    return options;
  }


  public void setOptions(List<MetadataOptionWrite2> options) {
   ...
   * @return the MetadataFieldWrite instance itself
   */
  public MetadataFieldWrite putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, metadataFieldWrite.description) &&
        Objects.equals(this.type, metadataFieldWrite.type) &&
        ...
        Objects.equals(this.additionalProperties, metadataFieldWrite.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MetadataFieldWrite
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetadataFieldWrite.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MetadataFieldWrite is not found in the empty JSON string", MetadataFieldWrite.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MetadataFieldWrite.openapiRequiredFields) {
      ...
      if (jsonObj.get("options") != null && !jsonObj.get("options").isJsonNull()) {
        ...
        if (jsonArrayoptions != null) {
          ...
          for (int i = 0; i < jsonArrayoptions.size(); i++) {
            MetadataOptionWrite2.validateJsonObject(jsonArrayoptions.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetadataFieldWrite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetadataFieldWrite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetadataFieldWrite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetadataFieldWrite.class));

       return (TypeAdapter<T>) new TypeAdapter<MetadataFieldWrite>() {
           @Override
           public void write(JsonWriter out, MetadataFieldWrite value) throws IOException {
           ...
           @Override
           public MetadataFieldWrite read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MetadataFieldWrite instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MetadataFieldWrite given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MetadataFieldWrite
  * @throws IOException if the JSON string is invalid with respect to MetadataFieldWrite
  */
  public static MetadataFieldWrite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetadataFieldWrite.class);
  }

 /**
  * Convert an instance of MetadataFieldWrite to an JSON string
  *
  * @return JSON string
  */
