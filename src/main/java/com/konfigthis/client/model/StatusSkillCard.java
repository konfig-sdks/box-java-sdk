 ...
 */
@ApiModel(description = "A Box Skill metadata card that puts a status message in the metadata sidebar.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class StatusSkillCard {
 ...
 public enum SkillCardTypeEnum {
  ...
  public StatusSkillCard createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public StatusSkillCard skill(StatusSkillCardSkill skill) {
  ...
  **/
  ...
  public StatusSkillCard invocation(StatusSkillCardInvocation invocation) {
  ...
  **/
   ...
   * @return the StatusSkillCard instance itself
   */
  public StatusSkillCard putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, statusSkillCard.createdAt) &&
        ...
        Objects.equals(this.additionalProperties, statusSkillCard.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, type, skillCardType, skillCardTitle, status, skill, invocation, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to StatusSkillCard
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StatusSkillCard.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatusSkillCard is not found in the empty JSON string", StatusSkillCard.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatusSkillCard.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatusSkillCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatusSkillCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatusSkillCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatusSkillCard.class));

       return (TypeAdapter<T>) new TypeAdapter<StatusSkillCard>() {
           @Override
           public void write(JsonWriter out, StatusSkillCard value) throws IOException {
           ...
           @Override
           public StatusSkillCard read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             StatusSkillCard instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of StatusSkillCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of StatusSkillCard
  * @throws IOException if the JSON string is invalid with respect to StatusSkillCard
  */
  public static StatusSkillCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatusSkillCard.class);
  }

 /**
  * Convert an instance of StatusSkillCard to an JSON string
  *
  * @return JSON string
  */
