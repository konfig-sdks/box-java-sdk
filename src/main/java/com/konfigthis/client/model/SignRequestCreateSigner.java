 ...
 */
@ApiModel(description = "The schema for a Signer in a POST Sign Request request body")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SignRequestCreateSigner {
 ...
 public enum RoleEnum {
  ...
  public SignRequestCreateSigner email(String email) {
  ...
  **/
  ...
  @ApiModelProperty(example = "example@gmail.com", value = "Email address of the signer. The email address of the signer is required when making signature requests, except when using templates that are configured to include emails.")
  ...
  public SignRequestCreateSigner role(RoleEnum role) {
  ...
  **/
  ...
  public SignRequestCreateSigner isInPerson(Boolean isInPerson) {
  ...
  **/
  ...
  public SignRequestCreateSigner order(Integer order) {
  ...
  **/
  ...
  public SignRequestCreateSigner embedUrlExternalUserId(String embedUrlExternalUserId) {
  ...
  **/
  ...
  public SignRequestCreateSigner redirectUrl(String redirectUrl) {
  ...
  **/
  ...
  public SignRequestCreateSigner declinedRedirectUrl(String declinedRedirectUrl) {
  ...
  **/
  ...
  public SignRequestCreateSigner loginRequired(Boolean loginRequired) {
  ...
  **/
  ...
  public SignRequestCreateSigner verificationPhoneNumber(String verificationPhoneNumber) {
  ...
  **/
  ...
  public SignRequestCreateSigner password(String password) {
  ...
  **/
  ...
  public SignRequestCreateSigner signerGroupId(String signerGroupId) {
  ...
  **/
   ...
   * @return the SignRequestCreateSigner instance itself
   */
  public SignRequestCreateSigner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SignRequestCreateSigner signRequestCreateSigner = (SignRequestCreateSigner) o;
    return Objects.equals(this.email, signRequestCreateSigner.email) &&
        Objects.equals(this.role, signRequestCreateSigner.role) &&
        Objects.equals(this.isInPerson, signRequestCreateSigner.isInPerson) &&
        Objects.equals(this.order, signRequestCreateSigner.order) &&
        Objects.equals(this.embedUrlExternalUserId, signRequestCreateSigner.embedUrlExternalUserId) &&
        Objects.equals(this.redirectUrl, signRequestCreateSigner.redirectUrl) &&
        Objects.equals(this.declinedRedirectUrl, signRequestCreateSigner.declinedRedirectUrl) &&
        Objects.equals(this.loginRequired, signRequestCreateSigner.loginRequired) &&
        Objects.equals(this.verificationPhoneNumber, signRequestCreateSigner.verificationPhoneNumber) &&
        Objects.equals(this.password, signRequestCreateSigner.password) &&
        Objects.equals(this.signerGroupId, signRequestCreateSigner.signerGroupId)&&
        Objects.equals(this.additionalProperties, signRequestCreateSigner.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, role, isInPerson, order, embedUrlExternalUserId, redirectUrl, declinedRedirectUrl, loginRequired, verificationPhoneNumber, password, signerGroupId, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SignRequestCreateSigner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SignRequestCreateSigner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SignRequestCreateSigner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SignRequestCreateSigner is not found in the empty JSON string", SignRequestCreateSigner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SignRequestCreateSigner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SignRequestCreateSigner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SignRequestCreateSigner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SignRequestCreateSigner.class));

       return (TypeAdapter<T>) new TypeAdapter<SignRequestCreateSigner>() {
           @Override
           public void write(JsonWriter out, SignRequestCreateSigner value) throws IOException {
           ...
           @Override
           public SignRequestCreateSigner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SignRequestCreateSigner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SignRequestCreateSigner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SignRequestCreateSigner
  * @throws IOException if the JSON string is invalid with respect to SignRequestCreateSigner
  */
  public static SignRequestCreateSigner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SignRequestCreateSigner.class);
  }

 /**
  * Convert an instance of SignRequestCreateSigner to an JSON string
  *
  * @return JSON string
  */
