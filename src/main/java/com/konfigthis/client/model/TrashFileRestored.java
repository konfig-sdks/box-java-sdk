...
import com.konfigthis.client.model.TrashFileRestoredPathCollection;
 ...
 */
@ApiModel(description = "Represents a file restored from the trash.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TrashFileRestored {
 ...
 public enum TypeEnum {
  ...
  private TrashFileRestoredPathCollection pathCollection;
 ...
 public enum ItemStatusEnum {
  ...
  public TrashFileRestored description(String description) {
  ...
  **/
  ...
  public TrashFileRestored id(String id) {
  ...
  **/
  ...
  public TrashFileRestored etag(String etag) {
  ...
  **/
  ...
  public TrashFileRestored type(TypeEnum type) {
  ...
  **/
  ...
  public TrashFileRestored sequenceId(String sequenceId) {
  ...
  **/
  ...
  public TrashFileRestored name(String name) {
  ...
  **/
  ...
  public TrashFileRestored sha1(String sha1) {
  ...
  **/
  ...
  public TrashFileRestored fileVersion(TrashFileFileVersion fileVersion) {
  ...
  **/
  ...
  public TrashFileRestored size(Integer size) {
  ...
  **/
  ...
  public TrashFileRestored pathCollection(TrashFileRestoredPathCollection pathCollection) {
  ...
  **/
  ...
  public TrashFileRestoredPathCollection getPathCollection() {
    return pathCollection;
  }


  public void setPathCollection(TrashFileRestoredPathCollection pathCollection) {
  ...
  public TrashFileRestored createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public TrashFileRestored modifiedAt(OffsetDateTime modifiedAt) {
  ...
  **/
  ...
  public TrashFileRestored trashedAt(String trashedAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The time at which this file was put in the trash - becomes `null` after restore.")
  ...
  public TrashFileRestored purgedAt(String purgedAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The time at which this file is expected to be purged from the trash  - becomes `null` after restore.")
  ...
  public TrashFileRestored contentCreatedAt(OffsetDateTime contentCreatedAt) {
  ...
  **/
  ...
  public TrashFileRestored contentModifiedAt(OffsetDateTime contentModifiedAt) {
  ...
  **/
  ...
  public TrashFileRestored createdBy(TrashFileCreatedBy createdBy) {
  ...
  **/
  ...
  public TrashFileRestored modifiedBy(TrashFileModifiedBy modifiedBy) {
  ...
  **/
  ...
  public TrashFileRestored ownedBy(TrashFileOwnedBy ownedBy) {
  ...
  **/
  ...
  public TrashFileRestored sharedLink(String sharedLink) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The shared link for this file. This will be `null` if a file had been trashed, even though the original shared link does become active again.")
  ...
  public TrashFileRestored parent(TrashFileParent parent) {
  ...
  **/
  ...
  public TrashFileRestored itemStatus(ItemStatusEnum itemStatus) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "ACTIVE", required = true, value = "Defines if this item has been deleted or not.  * `active` when the item has is not in the trash * `trashed` when the item has been moved to the trash but not deleted * `deleted` when the item has been permanently deleted.")
   ...
   * @return the TrashFileRestored instance itself
   */
  public TrashFileRestored putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TrashFileRestored trashFileRestored = (TrashFileRestored) o;
    return Objects.equals(this.description, trashFileRestored.description) &&
        Objects.equals(this.id, trashFileRestored.id) &&
        Objects.equals(this.etag, trashFileRestored.etag) &&
        Objects.equals(this.type, trashFileRestored.type) &&
        Objects.equals(this.sequenceId, trashFileRestored.sequenceId) &&
        Objects.equals(this.name, trashFileRestored.name) &&
        Objects.equals(this.sha1, trashFileRestored.sha1) &&
        Objects.equals(this.fileVersion, trashFileRestored.fileVersion) &&
        Objects.equals(this.size, trashFileRestored.size) &&
        Objects.equals(this.pathCollection, trashFileRestored.pathCollection) &&
        Objects.equals(this.createdAt, trashFileRestored.createdAt) &&
        Objects.equals(this.modifiedAt, trashFileRestored.modifiedAt) &&
        Objects.equals(this.trashedAt, trashFileRestored.trashedAt) &&
        Objects.equals(this.purgedAt, trashFileRestored.purgedAt) &&
        Objects.equals(this.contentCreatedAt, trashFileRestored.contentCreatedAt) &&
        Objects.equals(this.contentModifiedAt, trashFileRestored.contentModifiedAt) &&
        Objects.equals(this.createdBy, trashFileRestored.createdBy) &&
        Objects.equals(this.modifiedBy, trashFileRestored.modifiedBy) &&
        Objects.equals(this.ownedBy, trashFileRestored.ownedBy) &&
        Objects.equals(this.sharedLink, trashFileRestored.sharedLink) &&
        Objects.equals(this.parent, trashFileRestored.parent) &&
        Objects.equals(this.itemStatus, trashFileRestored.itemStatus)&&
        Objects.equals(this.additionalProperties, trashFileRestored.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrashFileRestored {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TrashFileRestored
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TrashFileRestored.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrashFileRestored is not found in the empty JSON string", TrashFileRestored.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrashFileRestored.openapiRequiredFields) {
      ...
      TrashFileRestoredPathCollection.validateJsonObject(jsonObj.getAsJsonObject("path_collection"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrashFileRestored.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrashFileRestored' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrashFileRestored> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrashFileRestored.class));

       return (TypeAdapter<T>) new TypeAdapter<TrashFileRestored>() {
           @Override
           public void write(JsonWriter out, TrashFileRestored value) throws IOException {
           ...
           @Override
           public TrashFileRestored read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TrashFileRestored instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TrashFileRestored given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TrashFileRestored
  * @throws IOException if the JSON string is invalid with respect to TrashFileRestored
  */
  public static TrashFileRestored fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrashFileRestored.class);
  }

 /**
  * Convert an instance of TrashFileRestored to an JSON string
  *
  * @return JSON string
  */
