...
public class AMetadataInstanceUpdateOperation1 {
  /**
 ...
 public enum OpEnum {
  ...
  public AMetadataInstanceUpdateOperation1() {
  }

  public AMetadataInstanceUpdateOperation1 op(OpEnum op) {
  ...
  **/
  ...
  public AMetadataInstanceUpdateOperation1 path(String path) {
  ...
  **/
  ...
  public AMetadataInstanceUpdateOperation1 value(String value) {
  ...
  **/
  ...
  public AMetadataInstanceUpdateOperation1 from(String from) {
  ...
  **/
   ...
   * @return the AMetadataInstanceUpdateOperation1 instance itself
   */
  public AMetadataInstanceUpdateOperation1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AMetadataInstanceUpdateOperation1 aMetadataInstanceUpdateOperation1 = (AMetadataInstanceUpdateOperation1) o;
    return Objects.equals(this.op, aMetadataInstanceUpdateOperation1.op) &&
        Objects.equals(this.path, aMetadataInstanceUpdateOperation1.path) &&
        Objects.equals(this.value, aMetadataInstanceUpdateOperation1.value) &&
        Objects.equals(this.from, aMetadataInstanceUpdateOperation1.from)&&
        Objects.equals(this.additionalProperties, aMetadataInstanceUpdateOperation1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AMetadataInstanceUpdateOperation1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AMetadataInstanceUpdateOperation1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AMetadataInstanceUpdateOperation1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AMetadataInstanceUpdateOperation1 is not found in the empty JSON string", AMetadataInstanceUpdateOperation1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AMetadataInstanceUpdateOperation1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AMetadataInstanceUpdateOperation1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AMetadataInstanceUpdateOperation1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AMetadataInstanceUpdateOperation1.class));

       return (TypeAdapter<T>) new TypeAdapter<AMetadataInstanceUpdateOperation1>() {
           @Override
           public void write(JsonWriter out, AMetadataInstanceUpdateOperation1 value) throws IOException {
           ...
           @Override
           public AMetadataInstanceUpdateOperation1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AMetadataInstanceUpdateOperation1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AMetadataInstanceUpdateOperation1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AMetadataInstanceUpdateOperation1
  * @throws IOException if the JSON string is invalid with respect to AMetadataInstanceUpdateOperation1
  */
  public static AMetadataInstanceUpdateOperation1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AMetadataInstanceUpdateOperation1.class);
  }

 /**
  * Convert an instance of AMetadataInstanceUpdateOperation1 to an JSON string
  *
  * @return JSON string
  */
