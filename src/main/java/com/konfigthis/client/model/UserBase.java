 ...
 */
@ApiModel(description = "A mini representation of a user, used when nested within another resource.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UserBase {
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : UserBase.openapiRequiredFields) {
