...
public class UploadSessionSessionEndpoints {
  ...
  public UploadSessionSessionEndpoints() {
  }

  public UploadSessionSessionEndpoints uploadPart(String uploadPart) {
  ...
  **/
  ...
  public UploadSessionSessionEndpoints commit(String commit) {
  ...
  **/
  ...
  public UploadSessionSessionEndpoints abort(String abort) {
  ...
  **/
  ...
  public UploadSessionSessionEndpoints listParts(String listParts) {
  ...
  **/
  ...
  public UploadSessionSessionEndpoints status(String status) {
  ...
  **/
  ...
  public UploadSessionSessionEndpoints logEvent(String logEvent) {
  ...
  **/
   ...
   * @return the UploadSessionSessionEndpoints instance itself
   */
  public UploadSessionSessionEndpoints putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UploadSessionSessionEndpoints uploadSessionSessionEndpoints = (UploadSessionSessionEndpoints) o;
    return Objects.equals(this.uploadPart, uploadSessionSessionEndpoints.uploadPart) &&
        Objects.equals(this.commit, uploadSessionSessionEndpoints.commit) &&
        Objects.equals(this.abort, uploadSessionSessionEndpoints.abort) &&
        Objects.equals(this.listParts, uploadSessionSessionEndpoints.listParts) &&
        Objects.equals(this.status, uploadSessionSessionEndpoints.status) &&
        Objects.equals(this.logEvent, uploadSessionSessionEndpoints.logEvent)&&
        Objects.equals(this.additionalProperties, uploadSessionSessionEndpoints.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UploadSessionSessionEndpoints {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UploadSessionSessionEndpoints
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UploadSessionSessionEndpoints.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UploadSessionSessionEndpoints is not found in the empty JSON string", UploadSessionSessionEndpoints.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UploadSessionSessionEndpoints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UploadSessionSessionEndpoints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UploadSessionSessionEndpoints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UploadSessionSessionEndpoints.class));

       return (TypeAdapter<T>) new TypeAdapter<UploadSessionSessionEndpoints>() {
           @Override
           public void write(JsonWriter out, UploadSessionSessionEndpoints value) throws IOException {
           ...
           @Override
           public UploadSessionSessionEndpoints read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UploadSessionSessionEndpoints instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UploadSessionSessionEndpoints given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UploadSessionSessionEndpoints
  * @throws IOException if the JSON string is invalid with respect to UploadSessionSessionEndpoints
  */
  public static UploadSessionSessionEndpoints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UploadSessionSessionEndpoints.class);
  }

 /**
  * Convert an instance of UploadSessionSessionEndpoints to an JSON string
  *
  * @return JSON string
  */
