 ...
 */
@ApiModel(description = "An invite for a user to an enterprise.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Invite {
  ...
  **/
  ...
  @ApiModelProperty(example = "11446498", required = true, value = "The unique identifier for this invite")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "INVITE", required = true, value = "`invite`")
  ...
  public Invite invitedTo(EnterpriseProperty invitedTo) {
  ...
  **/
  ...
  public EnterpriseProperty getInvitedTo() {
    return invitedTo;
  }


  public void setInvitedTo(EnterpriseProperty invitedTo) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "pending", value = "The status of the invite")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2012-12-12T10:53:43-08:00", value = "When the invite was created")
  ...
  public Invite modifiedAt(OffsetDateTime modifiedAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2012-12-12T10:53:43-08:00", value = "When the invite was modified.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, invitedTo, actionableBy, invitedBy, status, createdAt, modifiedAt, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Invite.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      // validate the optional field `invited_to`
      if (jsonObj.get("invited_to") != null && !jsonObj.get("invited_to").isJsonNull()) {
        EnterpriseProperty.validateJsonObject(jsonObj.getAsJsonObject("invited_to"));
      }
      // validate the optional field `actionable_by`
      if (jsonObj.get("actionable_by") != null && !jsonObj.get("actionable_by").isJsonNull()) {
        UserMini.validateJsonObject(jsonObj.getAsJsonObject("actionable_by"));
      }
      // validate the optional field `invited_by`
      if (jsonObj.get("invited_by") != null && !jsonObj.get("invited_by").isJsonNull()) {
        UserMini.validateJsonObject(jsonObj.getAsJsonObject("invited_by"));
      }
