 ...
 */
@ApiModel(description = "A standard representation of a file version from fa-adaptor")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FaFileVersion {
 ...
 public enum TypeEnum {
  ...
  public FaFileVersion() {
  }

  public FaFileVersion createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public FaFileVersion createdBy(FaFileVersionCreatedBy createdBy) {
  ...
  **/
  ...
  public FaFileVersion id(String id) {
  ...
  **/
  ...
  public FaFileVersion number(Integer number) {
  ...
  **/
  ...
  public FaFileVersion restoredAt(OffsetDateTime restoredAt) {
  ...
  **/
  ...
  public FaFileVersion restoredBy(FaFileVersionRestoredBy restoredBy) {
  ...
  **/
  ...
  public FaFileVersion trashedAt(OffsetDateTime trashedAt) {
  ...
  **/
  ...
  public FaFileVersion trashedBy(FaFileVersionTrashedBy trashedBy) {
  ...
  **/
  ...
  public FaFileVersion type(TypeEnum type) {
  ...
  **/
   ...
   * @return the FaFileVersion instance itself
   */
  public FaFileVersion putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FaFileVersion faFileVersion = (FaFileVersion) o;
    return Objects.equals(this.createdAt, faFileVersion.createdAt) &&
        Objects.equals(this.createdBy, faFileVersion.createdBy) &&
        Objects.equals(this.id, faFileVersion.id) &&
        Objects.equals(this.number, faFileVersion.number) &&
        Objects.equals(this.restoredAt, faFileVersion.restoredAt) &&
        Objects.equals(this.restoredBy, faFileVersion.restoredBy) &&
        Objects.equals(this.trashedAt, faFileVersion.trashedAt) &&
        Objects.equals(this.trashedBy, faFileVersion.trashedBy) &&
        Objects.equals(this.type, faFileVersion.type)&&
        Objects.equals(this.additionalProperties, faFileVersion.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FaFileVersion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FaFileVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaFileVersion is not found in the empty JSON string", FaFileVersion.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FaFileVersion.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaFileVersion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaFileVersion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaFileVersion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaFileVersion.class));

       return (TypeAdapter<T>) new TypeAdapter<FaFileVersion>() {
           @Override
           public void write(JsonWriter out, FaFileVersion value) throws IOException {
           ...
           @Override
           public FaFileVersion read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FaFileVersion instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FaFileVersion given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FaFileVersion
  * @throws IOException if the JSON string is invalid with respect to FaFileVersion
  */
  public static FaFileVersion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaFileVersion.class);
  }

 /**
  * Convert an instance of FaFileVersion to an JSON string
  *
  * @return JSON string
  */
