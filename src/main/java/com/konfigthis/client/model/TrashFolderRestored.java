...
import com.konfigthis.client.model.TrashFolderRestoredPathCollection;
 ...
 */
@ApiModel(description = "Represents a folder restored from the trash.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TrashFolderRestored {
 ...
 public enum TypeEnum {
  ...
  private TrashFolderRestoredPathCollection pathCollection;
 ...
 public enum ItemStatusEnum {
  ...
  public TrashFolderRestored description(String description) {
  ...
  **/
  ...
  public TrashFolderRestored id(String id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123456789", value = "The unique identifier that represent a folder.  The ID for any folder can be determined by visiting a folder in the web application and copying the ID from the URL. For example, for the URL `https://_*.app.box.com/folders/123` the `folder_id` is `123`.")
  ...
  public TrashFolderRestored etag(String etag) {
  ...
  **/
  ...
  public TrashFolderRestored type(TypeEnum type) {
  ...
  **/
  ...
  public TrashFolderRestored sequenceId(String sequenceId) {
  ...
  **/
  ...
  public TrashFolderRestored name(String name) {
  ...
  **/
  ...
  public TrashFolderRestored createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public TrashFolderRestored modifiedAt(OffsetDateTime modifiedAt) {
  ...
  **/
  ...
  public TrashFolderRestored size(Long size) {
  ...
  **/
  ...
  public TrashFolderRestored pathCollection(TrashFolderRestoredPathCollection pathCollection) {
  ...
  **/
  ...
  public TrashFolderRestoredPathCollection getPathCollection() {
    return pathCollection;
  }


  public void setPathCollection(TrashFolderRestoredPathCollection pathCollection) {
  ...
  public TrashFolderRestored createdBy(TrashFolderCreatedBy createdBy) {
  ...
  **/
  ...
  public TrashFolderRestored modifiedBy(TrashFolderModifiedBy modifiedBy) {
  ...
  **/
  ...
  public TrashFolderRestored trashedAt(String trashedAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The time at which this folder was put in the trash - becomes `null` after restore.")
  ...
  public TrashFolderRestored purgedAt(String purgedAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The time at which this folder is expected to be purged from the trash  - becomes `null` after restore.")
  ...
  public TrashFolderRestored contentCreatedAt(OffsetDateTime contentCreatedAt) {
  ...
  **/
  ...
  public TrashFolderRestored contentModifiedAt(OffsetDateTime contentModifiedAt) {
  ...
  **/
  ...
  public TrashFolderRestored ownedBy(TrashFolderOwnedBy ownedBy) {
  ...
  **/
  ...
  public TrashFolderRestored sharedLink(String sharedLink) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The shared link for this file. This will be `null` if a folder had been trashed, even though the original shared link does become active again.")
  ...
  public TrashFolderRestored folderUploadEmail(String folderUploadEmail) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The folder upload email for this folder. This will be `null` if a folder has been trashed, even though the original upload email does become active again.")
  ...
  public TrashFolderRestored parent(TrashFolderParent parent) {
  ...
  **/
  ...
  public TrashFolderRestored itemStatus(ItemStatusEnum itemStatus) {
  ...
  **/
   ...
   * @return the TrashFolderRestored instance itself
   */
  public TrashFolderRestored putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TrashFolderRestored trashFolderRestored = (TrashFolderRestored) o;
    return Objects.equals(this.description, trashFolderRestored.description) &&
        Objects.equals(this.id, trashFolderRestored.id) &&
        Objects.equals(this.etag, trashFolderRestored.etag) &&
        Objects.equals(this.type, trashFolderRestored.type) &&
        Objects.equals(this.sequenceId, trashFolderRestored.sequenceId) &&
        Objects.equals(this.name, trashFolderRestored.name) &&
        Objects.equals(this.createdAt, trashFolderRestored.createdAt) &&
        Objects.equals(this.modifiedAt, trashFolderRestored.modifiedAt) &&
        Objects.equals(this.size, trashFolderRestored.size) &&
        Objects.equals(this.pathCollection, trashFolderRestored.pathCollection) &&
        Objects.equals(this.createdBy, trashFolderRestored.createdBy) &&
        Objects.equals(this.modifiedBy, trashFolderRestored.modifiedBy) &&
        Objects.equals(this.trashedAt, trashFolderRestored.trashedAt) &&
        Objects.equals(this.purgedAt, trashFolderRestored.purgedAt) &&
        Objects.equals(this.contentCreatedAt, trashFolderRestored.contentCreatedAt) &&
        Objects.equals(this.contentModifiedAt, trashFolderRestored.contentModifiedAt) &&
        Objects.equals(this.ownedBy, trashFolderRestored.ownedBy) &&
        Objects.equals(this.sharedLink, trashFolderRestored.sharedLink) &&
        Objects.equals(this.folderUploadEmail, trashFolderRestored.folderUploadEmail) &&
        Objects.equals(this.parent, trashFolderRestored.parent) &&
        Objects.equals(this.itemStatus, trashFolderRestored.itemStatus)&&
        Objects.equals(this.additionalProperties, trashFolderRestored.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrashFolderRestored {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TrashFolderRestored
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TrashFolderRestored.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrashFolderRestored is not found in the empty JSON string", TrashFolderRestored.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("path_collection") != null && !jsonObj.get("path_collection").isJsonNull()) {
        TrashFolderRestoredPathCollection.validateJsonObject(jsonObj.getAsJsonObject("path_collection"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrashFolderRestored.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrashFolderRestored' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrashFolderRestored> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrashFolderRestored.class));

       return (TypeAdapter<T>) new TypeAdapter<TrashFolderRestored>() {
           @Override
           public void write(JsonWriter out, TrashFolderRestored value) throws IOException {
           ...
           @Override
           public TrashFolderRestored read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TrashFolderRestored instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TrashFolderRestored given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TrashFolderRestored
  * @throws IOException if the JSON string is invalid with respect to TrashFolderRestored
  */
  public static TrashFolderRestored fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrashFolderRestored.class);
  }

 /**
  * Convert an instance of TrashFolderRestored to an JSON string
  *
  * @return JSON string
  */
