...
public class WebhookInvocationSource {
 ...
 public enum ItemStatusEnum {
  ...
  public WebhookInvocationSource() {
  }

  public WebhookInvocationSource id(String id) {
  ...
  **/
  ...
  public WebhookInvocationSource etag(String etag) {
  ...
  **/
  ...
  public WebhookInvocationSource type(TypeEnum type) {
  ...
  **/
  ...
  public WebhookInvocationSource sequenceId(String sequenceId) {
  ...
  **/
  ...
  public WebhookInvocationSource name(String name) {
  ...
  **/
  ...
  public WebhookInvocationSource sha1(String sha1) {
  ...
  **/
  ...
  public WebhookInvocationSource fileVersion(FileVersionMini fileVersion) {
  ...
  **/
  ...
  public WebhookInvocationSource description(String description) {
  ...
  **/
  ...
  public WebhookInvocationSource size(Long size) {
  ...
  **/
  ...
  public WebhookInvocationSource pathCollection(Object pathCollection) {
  ...
  **/
  ...
  public WebhookInvocationSource createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public WebhookInvocationSource modifiedAt(OffsetDateTime modifiedAt) {
  ...
  **/
  ...
  public WebhookInvocationSource trashedAt(OffsetDateTime trashedAt) {
  ...
  **/
  ...
  public WebhookInvocationSource purgedAt(OffsetDateTime purgedAt) {
  ...
  **/
  ...
  public WebhookInvocationSource contentCreatedAt(OffsetDateTime contentCreatedAt) {
  ...
  **/
  ...
  public WebhookInvocationSource contentModifiedAt(OffsetDateTime contentModifiedAt) {
  ...
  **/
  ...
  public WebhookInvocationSource createdBy(UserMini createdBy) {
  ...
  **/
  ...
  public WebhookInvocationSource modifiedBy(UserMini modifiedBy) {
  ...
  **/
  ...
  public WebhookInvocationSource ownedBy(UserMini ownedBy) {
  ...
  **/
  ...
  public WebhookInvocationSource sharedLink(Object sharedLink) {
  ...
  **/
  ...
  public WebhookInvocationSource parent(FolderMini parent) {
  ...
  **/
  ...
  public WebhookInvocationSource itemStatus(ItemStatusEnum itemStatus) {
  ...
  **/
  ...
  public WebhookInvocationSource folderUploadEmail(FolderAllOfFolderUploadEmail folderUploadEmail) {
  ...
  **/
  ...
  public WebhookInvocationSource itemCollection(Items itemCollection) {
  ...
  **/
   ...
   * @return the WebhookInvocationSource instance itself
   */
  public WebhookInvocationSource putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebhookInvocationSource webhookInvocationSource = (WebhookInvocationSource) o;
    return Objects.equals(this.id, webhookInvocationSource.id) &&
        Objects.equals(this.etag, webhookInvocationSource.etag) &&
        Objects.equals(this.type, webhookInvocationSource.type) &&
        Objects.equals(this.sequenceId, webhookInvocationSource.sequenceId) &&
        Objects.equals(this.name, webhookInvocationSource.name) &&
        Objects.equals(this.sha1, webhookInvocationSource.sha1) &&
        Objects.equals(this.fileVersion, webhookInvocationSource.fileVersion) &&
        Objects.equals(this.description, webhookInvocationSource.description) &&
        Objects.equals(this.size, webhookInvocationSource.size) &&
        Objects.equals(this.pathCollection, webhookInvocationSource.pathCollection) &&
        Objects.equals(this.createdAt, webhookInvocationSource.createdAt) &&
        Objects.equals(this.modifiedAt, webhookInvocationSource.modifiedAt) &&
        Objects.equals(this.trashedAt, webhookInvocationSource.trashedAt) &&
        Objects.equals(this.purgedAt, webhookInvocationSource.purgedAt) &&
        Objects.equals(this.contentCreatedAt, webhookInvocationSource.contentCreatedAt) &&
        Objects.equals(this.contentModifiedAt, webhookInvocationSource.contentModifiedAt) &&
        Objects.equals(this.createdBy, webhookInvocationSource.createdBy) &&
        Objects.equals(this.modifiedBy, webhookInvocationSource.modifiedBy) &&
        Objects.equals(this.ownedBy, webhookInvocationSource.ownedBy) &&
        Objects.equals(this.sharedLink, webhookInvocationSource.sharedLink) &&
        Objects.equals(this.parent, webhookInvocationSource.parent) &&
        Objects.equals(this.itemStatus, webhookInvocationSource.itemStatus) &&
        Objects.equals(this.folderUploadEmail, webhookInvocationSource.folderUploadEmail) &&
        Objects.equals(this.itemCollection, webhookInvocationSource.itemCollection)&&
        Objects.equals(this.additionalProperties, webhookInvocationSource.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookInvocationSource {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookInvocationSource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookInvocationSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookInvocationSource is not found in the empty JSON string", WebhookInvocationSource.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookInvocationSource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookInvocationSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookInvocationSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookInvocationSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookInvocationSource.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookInvocationSource>() {
           @Override
           public void write(JsonWriter out, WebhookInvocationSource value) throws IOException {
           ...
           @Override
           public WebhookInvocationSource read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebhookInvocationSource instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebhookInvocationSource given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookInvocationSource
  * @throws IOException if the JSON string is invalid with respect to WebhookInvocationSource
  */
  public static WebhookInvocationSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookInvocationSource.class);
  }

 /**
  * Convert an instance of WebhookInvocationSource to an JSON string
  *
  * @return JSON string
  */
