 ...
 */
@ApiModel(description = "A mini representation of a retention policy, used when nested within another resource.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class RetentionPolicyMini {
 ...
 public enum DispositionActionEnum {
  ...
  public RetentionPolicyMini() {
  }

  public RetentionPolicyMini id(String id) {
  ...
  **/
  ...
  public RetentionPolicyMini type(TypeEnum type) {
  ...
  **/
   ...
   * @return the RetentionPolicyMini instance itself
   */
  public RetentionPolicyMini putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, retentionPolicyMini.id) &&
        Objects.equals(this.type, retentionPolicyMini.type) &&
        Objects.equals(this.policyName, retentionPolicyMini.policyName) &&
        ...
        Objects.equals(this.additionalProperties, retentionPolicyMini.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RetentionPolicyMini
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RetentionPolicyMini.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetentionPolicyMini is not found in the empty JSON string", RetentionPolicyMini.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RetentionPolicyMini.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetentionPolicyMini.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetentionPolicyMini' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetentionPolicyMini> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetentionPolicyMini.class));

       return (TypeAdapter<T>) new TypeAdapter<RetentionPolicyMini>() {
           @Override
           public void write(JsonWriter out, RetentionPolicyMini value) throws IOException {
           ...
           @Override
           public RetentionPolicyMini read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RetentionPolicyMini instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RetentionPolicyMini given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RetentionPolicyMini
  * @throws IOException if the JSON string is invalid with respect to RetentionPolicyMini
  */
  public static RetentionPolicyMini fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetentionPolicyMini.class);
  }

 /**
  * Convert an instance of RetentionPolicyMini to an JSON string
  *
  * @return JSON string
  */
