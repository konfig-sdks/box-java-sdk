...
import com.konfigthis.client.model.GroupsAllOfOrder;
...
public class GroupsAllOf {
  ...
  private List<GroupsAllOfOrder> order = null;

  public GroupsAllOf() {
  }

  public GroupsAllOf totalCount(Long totalCount) {
  ...
  **/
  ...
  public GroupsAllOf limit(Long limit) {
  ...
  **/
  ...
  public GroupsAllOf offset(Long offset) {
  ...
  **/
  ...
  public GroupsAllOf order(List<GroupsAllOfOrder> order) {
  ...
  public GroupsAllOf addOrderItem(GroupsAllOfOrder orderItem) {
    if (this.order == null) {
  ...
  **/
  ...
  public List<GroupsAllOfOrder> getOrder() {
    return order;
  }


  public void setOrder(List<GroupsAllOfOrder> order) {
   ...
   * @return the GroupsAllOf instance itself
   */
  public GroupsAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GroupsAllOf groupsAllOf = (GroupsAllOf) o;
    return Objects.equals(this.totalCount, groupsAllOf.totalCount) &&
        Objects.equals(this.limit, groupsAllOf.limit) &&
        Objects.equals(this.offset, groupsAllOf.offset) &&
        Objects.equals(this.order, groupsAllOf.order)&&
        Objects.equals(this.additionalProperties, groupsAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroupsAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroupsAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupsAllOf is not found in the empty JSON string", GroupsAllOf.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("order") != null && !jsonObj.get("order").isJsonNull()) {
        ...
        if (jsonArrayorder != null) {
          ...
          for (int i = 0; i < jsonArrayorder.size(); i++) {
            GroupsAllOfOrder.validateJsonObject(jsonArrayorder.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupsAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupsAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupsAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupsAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupsAllOf>() {
           @Override
           public void write(JsonWriter out, GroupsAllOf value) throws IOException {
           ...
           @Override
           public GroupsAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroupsAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroupsAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroupsAllOf
  * @throws IOException if the JSON string is invalid with respect to GroupsAllOf
  */
  public static GroupsAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupsAllOf.class);
  }

 /**
  * Convert an instance of GroupsAllOf to an JSON string
  *
  * @return JSON string
  */
