 ...
 */
@ApiModel(description = "A list of event objects")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Events {
  public static final String SERIALIZED_NAME_CHUNK_SIZE = "chunk_size";
  @SerializedName(SERIALIZED_NAME_CHUNK_SIZE)
  private Long chunkSize;

  public static final String SERIALIZED_NAME_NEXT_STREAM_POSITION = "next_stream_position";
  @SerializedName(SERIALIZED_NAME_NEXT_STREAM_POSITION)
  ...
  **/
  ...
  @ApiModelProperty(example = "2", value = "The number of events returned in this response.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1152922976252290886", value = "The stream position of the start of the next page (chunk) of events.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(chunkSize, nextStreamPosition, entries, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("next_stream_position");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("next_stream_position") != null && !jsonObj.get("next_stream_position").isJsonNull()) && !jsonObj.get("next_stream_position").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `next_stream_position` to be a primitive type in the JSON string but got `%s`", jsonObj.get("next_stream_position").toString()));
      }
      if (jsonObj.get("entries") != null && !jsonObj.get("entries").isJsonNull()) {
        ...
        if (jsonArrayentries != null) {
          ...
          for (int i = 0; i < jsonArrayentries.size(); i++) {
            Event.validateJsonObject(jsonArrayentries.get(i).getAsJsonObject());
          };
        }
      }
  }
