...
import com.konfigthis.client.model.CollaborationsAllOfOrder;
...
public class CollaborationsAllOf {
  ...
  private List<CollaborationsAllOfOrder> order = null;

  public CollaborationsAllOf() {
  }

  public CollaborationsAllOf totalCount(Long totalCount) {
  ...
  **/
  ...
  public CollaborationsAllOf limit(Long limit) {
  ...
  **/
  ...
  public CollaborationsAllOf offset(Long offset) {
  ...
  **/
  ...
  public CollaborationsAllOf order(List<CollaborationsAllOfOrder> order) {
  ...
  public CollaborationsAllOf addOrderItem(CollaborationsAllOfOrder orderItem) {
    if (this.order == null) {
  ...
  **/
   ...
   * @return the CollaborationsAllOf instance itself
   */
  public CollaborationsAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CollaborationsAllOf collaborationsAllOf = (CollaborationsAllOf) o;
    return Objects.equals(this.totalCount, collaborationsAllOf.totalCount) &&
        Objects.equals(this.limit, collaborationsAllOf.limit) &&
        Objects.equals(this.offset, collaborationsAllOf.offset) &&
        Objects.equals(this.order, collaborationsAllOf.order)&&
        Objects.equals(this.additionalProperties, collaborationsAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CollaborationsAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CollaborationsAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CollaborationsAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CollaborationsAllOf is not found in the empty JSON string", CollaborationsAllOf.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("order") != null && !jsonObj.get("order").isJsonNull()) {
        ...
        if (jsonArrayorder != null) {
          ...
          for (int i = 0; i < jsonArrayorder.size(); i++) {
            CollaborationsAllOfOrder.validateJsonObject(jsonArrayorder.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CollaborationsAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CollaborationsAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CollaborationsAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CollaborationsAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CollaborationsAllOf>() {
           @Override
           public void write(JsonWriter out, CollaborationsAllOf value) throws IOException {
           ...
           @Override
           public CollaborationsAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CollaborationsAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CollaborationsAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CollaborationsAllOf
  * @throws IOException if the JSON string is invalid with respect to CollaborationsAllOf
  */
  public static CollaborationsAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CollaborationsAllOf.class);
  }

 /**
  * Convert an instance of CollaborationsAllOf to an JSON string
  *
  * @return JSON string
  */
