 ...
 */
@ApiModel(description = "Legal Hold Assignments are used to assign Legal Hold Policies to Users, Folders, Files, or File Versions.  Creating a Legal Hold Assignment puts a hold on the File-Versions that belong to the Assignment's 'apply-to' entity.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class LegalHoldPolicyAssignment {
 ...
 public enum TypeEnum {
  ...
  public LegalHoldPolicyAssignment id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "11446498", value = "The unique identifier for this legal hold assignment")
  ...
  public LegalHoldPolicyAssignment type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "LEGAL_HOLD_POLICY_ASSIGNMENT", value = "`legal_hold_policy_assignment`")
  ...
  public LegalHoldPolicyAssignment legalHoldPolicy(LegalHoldPolicyMini legalHoldPolicy) {
  ...
  **/
  ...
  public LegalHoldPolicyAssignment assignedBy(UserMini assignedBy) {
  ...
  **/
  ...
  public LegalHoldPolicyAssignment assignedAt(OffsetDateTime assignedAt) {
  ...
  **/
  ...
  public LegalHoldPolicyAssignment deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
   ...
   * @return the LegalHoldPolicyAssignment instance itself
   */
  public LegalHoldPolicyAssignment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, legalHoldPolicyAssignment.id) &&
        Objects.equals(this.type, legalHoldPolicyAssignment.type) &&
        Objects.equals(this.legalHoldPolicy, legalHoldPolicyAssignment.legalHoldPolicy) &&
        ...
        Objects.equals(this.additionalProperties, legalHoldPolicyAssignment.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, type, legalHoldPolicy, assignedTo, assignedBy, assignedAt, deletedAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LegalHoldPolicyAssignment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LegalHoldPolicyAssignment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegalHoldPolicyAssignment is not found in the empty JSON string", LegalHoldPolicyAssignment.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegalHoldPolicyAssignment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegalHoldPolicyAssignment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegalHoldPolicyAssignment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegalHoldPolicyAssignment.class));

       return (TypeAdapter<T>) new TypeAdapter<LegalHoldPolicyAssignment>() {
           @Override
           public void write(JsonWriter out, LegalHoldPolicyAssignment value) throws IOException {
           ...
           @Override
           public LegalHoldPolicyAssignment read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LegalHoldPolicyAssignment instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LegalHoldPolicyAssignment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LegalHoldPolicyAssignment
  * @throws IOException if the JSON string is invalid with respect to LegalHoldPolicyAssignment
  */
  public static LegalHoldPolicyAssignment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegalHoldPolicyAssignment.class);
  }

 /**
  * Convert an instance of LegalHoldPolicyAssignment to an JSON string
  *
  * @return JSON string
  */
