...
import com.konfigthis.client.model.FileVersionsAllOfOrder;
 ...
 */
@ApiModel(description = "A list of file versions")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FileVersions {
  ...
  private List<FileVersionsAllOfOrder> order = null;

  public static final String SERIALIZED_NAME_ENTRIES = "entries";
  @SerializedName(SERIALIZED_NAME_ENTRIES)
  private List<FileVersionFull> entries = null;

  public FileVersions() {
  }

  public FileVersions totalCount(Long totalCount) {
  ...
  **/
  ...
  public FileVersions limit(Long limit) {
  ...
  **/
  ...
  public FileVersions offset(Long offset) {
  ...
  **/
  ...
  public FileVersions order(List<FileVersionsAllOfOrder> order) {
  ...
  public FileVersions addOrderItem(FileVersionsAllOfOrder orderItem) {
    if (this.order == null) {
  ...
  **/
  ...
  public List<FileVersionsAllOfOrder> getOrder() {
    return order;
  }


  public void setOrder(List<FileVersionsAllOfOrder> order) {
  ...
  public FileVersions entries(List<FileVersionFull> entries) {
  ...
  public FileVersions addEntriesItem(FileVersionFull entriesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of file versions")
  ...
  public void setEntries(List<FileVersionFull> entries) {
   ...
   * @return the FileVersions instance itself
   */
  public FileVersions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalCount, fileVersions.totalCount) &&
        Objects.equals(this.limit, fileVersions.limit) &&
        Objects.equals(this.offset, fileVersions.offset) &&
        Objects.equals(this.order, fileVersions.order) &&
        Objects.equals(this.entries, fileVersions.entries)&&
        Objects.equals(this.additionalProperties, fileVersions.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileVersions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileVersions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileVersions is not found in the empty JSON string", FileVersions.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("order") != null && !jsonObj.get("order").isJsonNull()) {
        ...
        if (jsonArrayorder != null) {
          ...
          for (int i = 0; i < jsonArrayorder.size(); i++) {
            FileVersionsAllOfOrder.validateJsonObject(jsonArrayorder.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("entries") != null && !jsonObj.get("entries").isJsonNull()) {
        ...
        if (jsonArrayentries != null) {
          ...
          for (int i = 0; i < jsonArrayentries.size(); i++) {
            FileVersionFull.validateJsonObject(jsonArrayentries.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileVersions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileVersions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileVersions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileVersions.class));

       return (TypeAdapter<T>) new TypeAdapter<FileVersions>() {
           @Override
           public void write(JsonWriter out, FileVersions value) throws IOException {
           ...
           @Override
           public FileVersions read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileVersions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileVersions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileVersions
  * @throws IOException if the JSON string is invalid with respect to FileVersions
  */
  public static FileVersions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileVersions.class);
  }

 /**
  * Convert an instance of FileVersions to an JSON string
  *
  * @return JSON string
  */
