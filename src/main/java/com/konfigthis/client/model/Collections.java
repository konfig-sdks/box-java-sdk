 ...
 */
@ApiModel(description = "A list of collections")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Collections {
  ...
  public Collections totalCount(Long totalCount) {
  ...
  **/
  ...
  public Collections limit(Long limit) {
  ...
  **/
  ...
  public Collections offset(Long offset) {
  ...
  **/
  ...
  public Collections order(List<CollectionsAllOfOrder> order) {
  ...
  public Collections addOrderItem(CollectionsAllOfOrder orderItem) {
    if (this.order == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of collections")
   ...
   * @return the Collections instance itself
   */
  public Collections putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalCount, collections.totalCount) &&
        Objects.equals(this.limit, collections.limit) &&
        Objects.equals(this.offset, collections.offset) &&
        Objects.equals(this.order, collections.order) &&
        Objects.equals(this.entries, collections.entries)&&
        Objects.equals(this.additionalProperties, collections.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Collections
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Collections.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Collections is not found in the empty JSON string", Collections.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("entries") != null && !jsonObj.get("entries").isJsonNull()) {
        ...
        if (jsonArrayentries != null) {
          ...
          for (int i = 0; i < jsonArrayentries.size(); i++) {
            Collection.validateJsonObject(jsonArrayentries.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Collections.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Collections' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Collections> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Collections.class));

       return (TypeAdapter<T>) new TypeAdapter<Collections>() {
           @Override
           public void write(JsonWriter out, Collections value) throws IOException {
           ...
           @Override
           public Collections read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Collections instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Collections given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Collections
  * @throws IOException if the JSON string is invalid with respect to Collections
  */
  public static Collections fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Collections.class);
  }

 /**
  * Convert an instance of Collections to an JSON string
  *
  * @return JSON string
  */
