...
import com.konfigthis.client.model.CollectionsAllOfOrder;
...
public class CollectionsAllOf {
  ...
  private List<CollectionsAllOfOrder> order = null;

  public CollectionsAllOf() {
  }

  public CollectionsAllOf totalCount(Long totalCount) {
  ...
  **/
  ...
  public CollectionsAllOf limit(Long limit) {
  ...
  **/
  ...
  public CollectionsAllOf offset(Long offset) {
  ...
  **/
  ...
  public CollectionsAllOf order(List<CollectionsAllOfOrder> order) {
  ...
  public CollectionsAllOf addOrderItem(CollectionsAllOfOrder orderItem) {
    if (this.order == null) {
  ...
  **/
  ...
  public List<CollectionsAllOfOrder> getOrder() {
    return order;
  }


  public void setOrder(List<CollectionsAllOfOrder> order) {
   ...
   * @return the CollectionsAllOf instance itself
   */
  public CollectionsAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CollectionsAllOf collectionsAllOf = (CollectionsAllOf) o;
    return Objects.equals(this.totalCount, collectionsAllOf.totalCount) &&
        Objects.equals(this.limit, collectionsAllOf.limit) &&
        Objects.equals(this.offset, collectionsAllOf.offset) &&
        Objects.equals(this.order, collectionsAllOf.order)&&
        Objects.equals(this.additionalProperties, collectionsAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CollectionsAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CollectionsAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CollectionsAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CollectionsAllOf is not found in the empty JSON string", CollectionsAllOf.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("order") != null && !jsonObj.get("order").isJsonNull()) {
        ...
        if (jsonArrayorder != null) {
          ...
          for (int i = 0; i < jsonArrayorder.size(); i++) {
            CollectionsAllOfOrder.validateJsonObject(jsonArrayorder.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CollectionsAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CollectionsAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CollectionsAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CollectionsAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CollectionsAllOf>() {
           @Override
           public void write(JsonWriter out, CollectionsAllOf value) throws IOException {
           ...
           @Override
           public CollectionsAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CollectionsAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CollectionsAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CollectionsAllOf
  * @throws IOException if the JSON string is invalid with respect to CollectionsAllOf
  */
  public static CollectionsAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CollectionsAllOf.class);
  }

 /**
  * Convert an instance of CollectionsAllOf to an JSON string
  *
  * @return JSON string
  */
