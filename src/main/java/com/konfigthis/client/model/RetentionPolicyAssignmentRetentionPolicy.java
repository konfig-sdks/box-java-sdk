...
public class RetentionPolicyAssignmentRetentionPolicy {
 ...
 public enum DispositionActionEnum {
  ...
  public RetentionPolicyAssignmentRetentionPolicy() {
  }

  public RetentionPolicyAssignmentRetentionPolicy id(String id) {
  ...
  **/
  ...
  public RetentionPolicyAssignmentRetentionPolicy type(TypeEnum type) {
  ...
  **/
  ...
  public RetentionPolicyAssignmentRetentionPolicy policyName(String policyName) {
  ...
  **/
  ...
  public RetentionPolicyAssignmentRetentionPolicy retentionLength(String retentionLength) {
  ...
  **/
  ...
  public RetentionPolicyAssignmentRetentionPolicy dispositionAction(DispositionActionEnum dispositionAction) {
  ...
  **/
   ...
   * @return the RetentionPolicyAssignmentRetentionPolicy instance itself
   */
  public RetentionPolicyAssignmentRetentionPolicy putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RetentionPolicyAssignmentRetentionPolicy retentionPolicyAssignmentRetentionPolicy = (RetentionPolicyAssignmentRetentionPolicy) o;
    return Objects.equals(this.id, retentionPolicyAssignmentRetentionPolicy.id) &&
        Objects.equals(this.type, retentionPolicyAssignmentRetentionPolicy.type) &&
        Objects.equals(this.policyName, retentionPolicyAssignmentRetentionPolicy.policyName) &&
        Objects.equals(this.retentionLength, retentionPolicyAssignmentRetentionPolicy.retentionLength) &&
        Objects.equals(this.dispositionAction, retentionPolicyAssignmentRetentionPolicy.dispositionAction)&&
        Objects.equals(this.additionalProperties, retentionPolicyAssignmentRetentionPolicy.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetentionPolicyAssignmentRetentionPolicy {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RetentionPolicyAssignmentRetentionPolicy
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RetentionPolicyAssignmentRetentionPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetentionPolicyAssignmentRetentionPolicy is not found in the empty JSON string", RetentionPolicyAssignmentRetentionPolicy.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RetentionPolicyAssignmentRetentionPolicy.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetentionPolicyAssignmentRetentionPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetentionPolicyAssignmentRetentionPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetentionPolicyAssignmentRetentionPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetentionPolicyAssignmentRetentionPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<RetentionPolicyAssignmentRetentionPolicy>() {
           @Override
           public void write(JsonWriter out, RetentionPolicyAssignmentRetentionPolicy value) throws IOException {
           ...
           @Override
           public RetentionPolicyAssignmentRetentionPolicy read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RetentionPolicyAssignmentRetentionPolicy instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RetentionPolicyAssignmentRetentionPolicy given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RetentionPolicyAssignmentRetentionPolicy
  * @throws IOException if the JSON string is invalid with respect to RetentionPolicyAssignmentRetentionPolicy
  */
  public static RetentionPolicyAssignmentRetentionPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetentionPolicyAssignmentRetentionPolicy.class);
  }

 /**
  * Convert an instance of RetentionPolicyAssignmentRetentionPolicy to an JSON string
  *
  * @return JSON string
  */
