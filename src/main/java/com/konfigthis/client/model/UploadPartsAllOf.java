...
public class UploadPartsAllOf {
  ...
  public UploadPartsAllOf() {
  }

  public UploadPartsAllOf totalCount(Long totalCount) {
  ...
  **/
  ...
  public UploadPartsAllOf limit(Long limit) {
  ...
  **/
  ...
  public UploadPartsAllOf offset(Long offset) {
  ...
  **/
  ...
  public UploadPartsAllOf order(List<UploadPartsAllOfOrder> order) {
  ...
  public UploadPartsAllOf addOrderItem(UploadPartsAllOfOrder orderItem) {
    if (this.order == null) {
  ...
  **/
   ...
   * @return the UploadPartsAllOf instance itself
   */
  public UploadPartsAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UploadPartsAllOf uploadPartsAllOf = (UploadPartsAllOf) o;
    return Objects.equals(this.totalCount, uploadPartsAllOf.totalCount) &&
        Objects.equals(this.limit, uploadPartsAllOf.limit) &&
        Objects.equals(this.offset, uploadPartsAllOf.offset) &&
        Objects.equals(this.order, uploadPartsAllOf.order)&&
        Objects.equals(this.additionalProperties, uploadPartsAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UploadPartsAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UploadPartsAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UploadPartsAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UploadPartsAllOf is not found in the empty JSON string", UploadPartsAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UploadPartsAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UploadPartsAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UploadPartsAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UploadPartsAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<UploadPartsAllOf>() {
           @Override
           public void write(JsonWriter out, UploadPartsAllOf value) throws IOException {
           ...
           @Override
           public UploadPartsAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UploadPartsAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UploadPartsAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UploadPartsAllOf
  * @throws IOException if the JSON string is invalid with respect to UploadPartsAllOf
  */
  public static UploadPartsAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UploadPartsAllOf.class);
  }

 /**
  * Convert an instance of UploadPartsAllOf to an JSON string
  *
  * @return JSON string
  */
