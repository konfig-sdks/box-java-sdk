...
public class FileVersionsAllOf {
  ...
  public FileVersionsAllOf() {
  }

  public FileVersionsAllOf totalCount(Long totalCount) {
  ...
  **/
  ...
  public FileVersionsAllOf limit(Long limit) {
  ...
  **/
  ...
  public FileVersionsAllOf offset(Long offset) {
  ...
  **/
  ...
  public FileVersionsAllOf order(List<FileVersionsAllOfOrder> order) {
  ...
  public FileVersionsAllOf addOrderItem(FileVersionsAllOfOrder orderItem) {
    if (this.order == null) {
  ...
  **/
   ...
   * @return the FileVersionsAllOf instance itself
   */
  public FileVersionsAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileVersionsAllOf fileVersionsAllOf = (FileVersionsAllOf) o;
    return Objects.equals(this.totalCount, fileVersionsAllOf.totalCount) &&
        Objects.equals(this.limit, fileVersionsAllOf.limit) &&
        Objects.equals(this.offset, fileVersionsAllOf.offset) &&
        Objects.equals(this.order, fileVersionsAllOf.order)&&
        Objects.equals(this.additionalProperties, fileVersionsAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileVersionsAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileVersionsAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileVersionsAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileVersionsAllOf is not found in the empty JSON string", FileVersionsAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileVersionsAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileVersionsAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileVersionsAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileVersionsAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<FileVersionsAllOf>() {
           @Override
           public void write(JsonWriter out, FileVersionsAllOf value) throws IOException {
           ...
           @Override
           public FileVersionsAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileVersionsAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileVersionsAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileVersionsAllOf
  * @throws IOException if the JSON string is invalid with respect to FileVersionsAllOf
  */
  public static FileVersionsAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileVersionsAllOf.class);
  }

 /**
  * Convert an instance of FileVersionsAllOf to an JSON string
  *
  * @return JSON string
  */
