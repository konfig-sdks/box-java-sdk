 ...
 */
@ApiModel(description = "A standard representation of a group, as returned from any group API endpoints by default")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Group {
  ...
  **/
  ...
  public Group modifiedAt(OffsetDateTime modifiedAt) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, name, groupType, createdAt, modifiedAt, additionalProperties);
  }
