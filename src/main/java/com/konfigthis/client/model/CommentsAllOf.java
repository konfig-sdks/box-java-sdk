...
import com.konfigthis.client.model.CommentsAllOfOrder;
...
public class CommentsAllOf {
  ...
  private List<CommentsAllOfOrder> order = null;

  public CommentsAllOf() {
  }

  public CommentsAllOf totalCount(Long totalCount) {
  ...
  **/
  ...
  public CommentsAllOf limit(Long limit) {
  ...
  **/
  ...
  public CommentsAllOf offset(Long offset) {
  ...
  **/
  ...
  public CommentsAllOf order(List<CommentsAllOfOrder> order) {
  ...
  public CommentsAllOf addOrderItem(CommentsAllOfOrder orderItem) {
    if (this.order == null) {
  ...
  **/
  ...
  public List<CommentsAllOfOrder> getOrder() {
    return order;
  }


  public void setOrder(List<CommentsAllOfOrder> order) {
   ...
   * @return the CommentsAllOf instance itself
   */
  public CommentsAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CommentsAllOf commentsAllOf = (CommentsAllOf) o;
    return Objects.equals(this.totalCount, commentsAllOf.totalCount) &&
        Objects.equals(this.limit, commentsAllOf.limit) &&
        Objects.equals(this.offset, commentsAllOf.offset) &&
        Objects.equals(this.order, commentsAllOf.order)&&
        Objects.equals(this.additionalProperties, commentsAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CommentsAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CommentsAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommentsAllOf is not found in the empty JSON string", CommentsAllOf.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("order") != null && !jsonObj.get("order").isJsonNull()) {
        ...
        if (jsonArrayorder != null) {
          ...
          for (int i = 0; i < jsonArrayorder.size(); i++) {
            CommentsAllOfOrder.validateJsonObject(jsonArrayorder.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommentsAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommentsAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommentsAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommentsAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CommentsAllOf>() {
           @Override
           public void write(JsonWriter out, CommentsAllOf value) throws IOException {
           ...
           @Override
           public CommentsAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CommentsAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CommentsAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CommentsAllOf
  * @throws IOException if the JSON string is invalid with respect to CommentsAllOf
  */
  public static CommentsAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommentsAllOf.class);
  }

 /**
  * Convert an instance of CommentsAllOf to an JSON string
  *
  * @return JSON string
  */
