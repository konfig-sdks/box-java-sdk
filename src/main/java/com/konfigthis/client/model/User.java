 ...
 */
@ApiModel(description = "A standard representation of a user, as returned from any user API endpoints by default")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class User {
  ...
  **/
  ...
  public User notificationEmail(UserAllOfNotificationEmail notificationEmail) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, name, login, createdAt, modifiedAt, language, timezone, spaceAmount, spaceUsed, maxUploadSize, status, jobTitle, phone, address, avatarUrl, notificationEmail, additionalProperties);
  }
