 ...
 */
@ApiModel(description = "A mini representation of a file, used when nested under another resource.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FileMini {
  ...
  **/
  ...
  public FileMini etag(String etag) {
  ...
  **/
  ...
  public FileMini type(TypeEnum type) {
  ...
  **/
  ...
  public FileMini sequenceId(String sequenceId) {
  ...
  **/
   ...
   * @return the FileMini instance itself
   */
  public FileMini putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, fileMini.id) &&
        Objects.equals(this.etag, fileMini.etag) &&
        Objects.equals(this.type, fileMini.type) &&
        Objects.equals(this.sequenceId, fileMini.sequenceId) &&
        ...
        Objects.equals(this.additionalProperties, fileMini.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileMini
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileMini.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileMini is not found in the empty JSON string", FileMini.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileMini.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileMini.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileMini' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileMini> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileMini.class));

       return (TypeAdapter<T>) new TypeAdapter<FileMini>() {
           @Override
           public void write(JsonWriter out, FileMini value) throws IOException {
           ...
           @Override
           public FileMini read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileMini instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileMini given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileMini
  * @throws IOException if the JSON string is invalid with respect to FileMini
  */
  public static FileMini fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileMini.class);
  }

 /**
  * Convert an instance of FileMini to an JSON string
  *
  * @return JSON string
  */
