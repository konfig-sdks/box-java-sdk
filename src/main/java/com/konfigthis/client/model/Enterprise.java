...
public class Enterprise {
  ...
  **/
   ...
   * @return the Enterprise instance itself
   */
  public Enterprise putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, enterprise.id) &&
        ...
        Objects.equals(this.additionalProperties, enterprise.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Enterprise>() {
           ...
           public Enterprise read(JsonReader in) throws IOException {
             ...
             Enterprise instance = thisAdapter.fromJsonTree(jsonObj);
