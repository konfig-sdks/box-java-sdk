...
public class FaCommentAllOf {
 ...
 public enum StatusEnum {
  ...
  public FaCommentAllOf() {
  }

  public FaCommentAllOf createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public FaCommentAllOf createdBy(FileActivityUser createdBy) {
  ...
  **/
  ...
  public FaCommentAllOf isReplyComment(Boolean isReplyComment) {
  ...
  **/
  ...
  public FaCommentAllOf item(FaCommentBase item) {
  ...
  **/
  ...
  public FaCommentAllOf message(String message) {
  ...
  **/
  ...
  public FaCommentAllOf modifiedAt(OffsetDateTime modifiedAt) {
  ...
  **/
  ...
  public FaCommentAllOf parent(FaCommentBase parent) {
  ...
  **/
  ...
  public FaCommentAllOf replies(List<Reply> replies) {
  ...
  public FaCommentAllOf addRepliesItem(Reply repliesItem) {
  ...
  **/
  ...
  public FaCommentAllOf status(StatusEnum status) {
  ...
  **/
  ...
  public FaCommentAllOf totalReplyCount(Double totalReplyCount) {
  ...
  public FaCommentAllOf totalReplyCount(Integer totalReplyCount) {
  ...
  **/
   ...
   * @return the FaCommentAllOf instance itself
   */
  public FaCommentAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FaCommentAllOf faCommentAllOf = (FaCommentAllOf) o;
    return Objects.equals(this.createdAt, faCommentAllOf.createdAt) &&
        Objects.equals(this.createdBy, faCommentAllOf.createdBy) &&
        Objects.equals(this.isReplyComment, faCommentAllOf.isReplyComment) &&
        Objects.equals(this.item, faCommentAllOf.item) &&
        Objects.equals(this.message, faCommentAllOf.message) &&
        Objects.equals(this.modifiedAt, faCommentAllOf.modifiedAt) &&
        Objects.equals(this.parent, faCommentAllOf.parent) &&
        Objects.equals(this.replies, faCommentAllOf.replies) &&
        Objects.equals(this.status, faCommentAllOf.status) &&
        Objects.equals(this.totalReplyCount, faCommentAllOf.totalReplyCount)&&
        Objects.equals(this.additionalProperties, faCommentAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, createdBy, isReplyComment, item, message, modifiedAt, parent, replies, status, totalReplyCount, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FaCommentAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FaCommentAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FaCommentAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaCommentAllOf is not found in the empty JSON string", FaCommentAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaCommentAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaCommentAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaCommentAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaCommentAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<FaCommentAllOf>() {
           @Override
           public void write(JsonWriter out, FaCommentAllOf value) throws IOException {
           ...
           @Override
           public FaCommentAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FaCommentAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FaCommentAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FaCommentAllOf
  * @throws IOException if the JSON string is invalid with respect to FaCommentAllOf
  */
  public static FaCommentAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaCommentAllOf.class);
  }

 /**
  * Convert an instance of FaCommentAllOf to an JSON string
  *
  * @return JSON string
  */
