...
|**order** | [**List&lt;UploadPartsAllOfOrder&gt;**](UploadPartsAllOfOrder.md) | The order by which items are returned.  This field is only returned for calls that use offset-based pagination. For marker-based paginated APIs, this field will be omitted. |  [optional] |
|**entries** | [**List&lt;UploadPart&gt;**](UploadPart.md) | A list of uploaded chunks for an upload session |  [optional] |
