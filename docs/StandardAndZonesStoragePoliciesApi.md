...
|------------- | ------------- | -------------|
| [**getSpecific**](StandardAndZonesStoragePoliciesApi.md#getSpecific) | **GET** /storage_policies/{storage_policy_id} | Get storage policy |
| [**listPolicies**](StandardAndZonesStoragePoliciesApi.md#listPolicies) | **GET** /storage_policies | List storage policies |


<a name="getSpecific"></a>
# **getSpecific**
> StoragePolicy getSpecific(storagePolicyId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String storagePolicyId = "34342"; // The ID of the storage policy.
    try {
      StoragePolicy result = client
              .standardAndZonesStoragePolicies
              .getSpecific(storagePolicyId)
              .execute();
      ...
      System.err.println("Exception when calling StandardAndZonesStoragePoliciesApi#getSpecific");
    ...
    try {
      ApiResponse<StoragePolicy> response = client
              .standardAndZonesStoragePolicies
              .getSpecific(storagePolicyId)
              .executeWithHttpInfo();
...
# **listPolicies**
> StoragePolicies listPolicies().fields(fields).marker(marker).limit(limit).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling StandardAndZonesStoragePoliciesApi#listPolicies");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
    ...
    // Use .executeWithHttpInfo() to retrieve HTTP Status Code, Headers and Request
    try {
      ApiResponse<StoragePolicies> response = client
              .standardAndZonesStoragePolicies
              .listPolicies()
              .fields(fields)
              .marker(marker)
